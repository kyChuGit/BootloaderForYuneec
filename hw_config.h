...
# define USB_FORCE_DISCONNECT			1 /* Use to over come HW having errant 1.5K pull up on OTG_FS_DP */
...
#elif  defined(TARGET_HW_YUNEEC_DRONE)

# define APP_LOAD_ADDRESS               0x08008000
# define BOOTLOADER_DELAY               5000
# define INTERFACE_USB                  1
# define INTERFACE_USART                1
# define USBDEVICESTRING                "PX4 BL Yuneec Drone"
# define USBPRODUCTID                   0x0032
# define BOOT_DELAY_ADDRESS             0x000001a0
